...
class ReacTheme_Elementor_Team_Grid_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'team_shape',
			[
				'label' => esc_html__( 'Enable Shape', 'rtelements' ),
		...
		$this->add_control(
            'shape__bg',
            [
                'label' => esc_html__( 'Shape Background Color', 'rselements' ),
                'type' => Controls_Manager::COLOR,
                'condition' => [
                	'team_shape' => 'yes',
                ],
                'selectors' => [
                    '{{WRAPPER}} .enable__rt_team_shape_yes .solar-energy-team .inner-content, {{WRAPPER}} .enable__rt_team_shape_yes .solar-energy-team .thumbnail:before' => 'background: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .solar-energy-team .inner-content a .title, {{WRAPPER}} .team-grid-style1 .team-item .team-content h3.team-name' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .solar-energy-team .inner-content a .title:hover' => 'color: {{VALUE}};',
                ],                
            ]
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' =>
                    '{{WRAPPER}} .rs-team-grid .team-item .team-name a,.solar-energy-team .inner-content a .title'
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .solar-energy-team .inner-content span' => 'color: {{VALUE}};',
                ],                
            ]
        );
        $this->add_group_control(
			...
			[
				...
				'scheme' => Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
				'selector' =>
                    '{{WRAPPER}} .rs-team-grid .team-content .team-title,.solar-energy-team .inner-content span'
			]
		);
		...
		$this->add_responsive_control(
			'spinnedfafsddsfr_border_radius',
			[
				'label'      => __('Border Radius', 'plugin-name'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .team-grid-style3 .team-item .team-inner-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .solar-energy-team .thumbnail .share-team-h1 .share-nav li a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .solar-energy-team .thumbnail .share-icon i' => 'color: {{VALUE}};',
                ],
                'separator' => 'before',                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .solar-energy-team .thumbnail .share-icon:hover i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .solar-energy-team .thumbnail .share-team-h1 .share-nav li a:hover i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .team-grid-style3 .team-item .share-icon:hover i.fa-share-alt' => 'color: {{VALUE}} !important;',
                ],
                'separator' => 'before',                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .solar-energy-team .thumbnail .share-icon' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .solar-energy-team .thumbnail .share-team-h1 .share-nav li a' => 'background: {{VALUE}};',
                ],
                'separator' => 'before',                
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .solar-energy-team .thumbnail .share-icon:hover' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .solar-energy-team .thumbnail .share-team-h1 .share-nav li a:hover' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .share-icon:hover' => 'background: {{VALUE}} !important;',
                ],
                'separator' => 'before',                
            ]
        );
