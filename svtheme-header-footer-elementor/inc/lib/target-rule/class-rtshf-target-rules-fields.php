...
class RSHF_Target_Rules_Fields {
	...
	public static function get_location_selections() {
		...
		$special_pages = array(
			'special-404'    => __( '404 Page', 'rts-header-footer-elementor' ),
			'special-search' => __( 'Search Page', 'rts-header-footer-elementor' ),
			'special-blog'   => __( 'Blog / Posts Page', 'rts-header-footer-elementor' ),
			'special-front'  => __( 'Front Page', 'rts-header-footer-elementor' ),
			'special-date'   => __( 'Date Archive', 'rts-header-footer-elementor' ),
			'special-author' => __( 'Author Archive', 'rts-header-footer-elementor' ),
		);

		if ( class_exists( 'WooCommerce' ) ) {
			$special_pages['special-woo-shop'] = __( 'WooCommerce Shop Page', 'rts-header-footer-elementor' );
		}

		$selection_options = array(
			'basic'         => array(
				'label' => __( 'Basic', 'rts-header-footer-elementor' ),
				'value' => array(
					'basic-global'    => __( 'Entire Website', 'rts-header-footer-elementor' ),
					'basic-singulars' => __( 'All Singulars', 'rts-header-footer-elementor' ),
					'basic-archives'  => __( 'All Archives', 'rts-header-footer-elementor' ),
				),
			),

			'special-pages' => array(
				'label' => __( 'Special Pages', 'rts-header-footer-elementor' ),
				'value' => $special_pages,
			),
		);
		...
		$selection_options['specific-target'] = array(
			'label' => __( 'Specific Target', 'rts-header-footer-elementor' ),
			'value' => array(
				'specifics' => __( 'Specific Pages / Posts / Taxonomies, etc.', 'rts-header-footer-elementor' ),
			),
		);
	...
	public static function get_user_selections() {
		$selection_options = array(
			'basic'    => array(
				'label' => __( 'Basic', 'rts-header-footer-elementor' ),
				'value' => array(
					'all'        => __( 'All', 'rts-header-footer-elementor' ),
					'logged-in'  => __( 'Logged In', 'rts-header-footer-elementor' ),
					'logged-out' => __( 'Logged Out', 'rts-header-footer-elementor' ),
				),
			),

			'advanced' => array(
				'label' => __( 'Advanced', 'rts-header-footer-elementor' ),
				'value' => array(),
			),
		);
	...
	public function admin_styles() {
		...
		$localize_vars = array(
			'ast_lang'      => $ast_lang,
			'please_enter'  => __( 'Please enter', 'rts-header-footer-elementor' ),
			'please_delete' => __( 'Please delete', 'rts-header-footer-elementor' ),
			'more_char'     => __( 'or more characters', 'rts-header-footer-elementor' ),
			'character'     => __( 'character', 'rts-header-footer-elementor' ),
			'loading'       => __( 'Loading more results…', 'rts-header-footer-elementor' ),
			'only_select'   => __( 'You can only select', 'rts-header-footer-elementor' ),
			'item'          => __( 'item', 'rts-header-footer-elementor' ),
			'char_s'        => __( 's', 'rts-header-footer-elementor' ),
			'no_result'     => __( 'No results found', 'rts-header-footer-elementor' ),
			'searching'     => __( 'Searching…', 'rts-header-footer-elementor' ),
			'not_loader'    => __( 'The results could not be loaded.', 'rts-header-footer-elementor' ),
			'search'        => __( 'Search pages / post / categories', 'rts-header-footer-elementor' ),
	...
	public static function target_rule_settings_field( $name, $settings, $value ) {
		...
		$add_rule_label = isset( $settings['add_rule_label'] ) ? $settings['add_rule_label'] : __( 'Add Rule', 'rts-header-footer-elementor' );
		$saved_values   = $value;
		$output         = '';
		...
		$output .= '<option value="">' . __( 'Select', 'rts-header-footer-elementor' ) . '</option>';
	...
	public static function get_post_target_rule_options( $post_type, $taxonomy ) {
		...
		$all_posts                          = sprintf( __( 'All %s', 'rts-header-footer-elementor' ), $post_label );
		$post_option[ $post_name . '|all' ] = $all_posts;

		if ( 'pages' != $post_key ) {
			/* translators: %s post label */
			$all_archive                                = sprintf( __( 'All %s Archive', 'rts-header-footer-elementor' ), $post_label );
		...
		if ( in_array( $post_type->name, $taxonomy->object_type ) ) {
			...
			$tax_archive = sprintf( __( 'All %s Archive', 'rts-header-footer-elementor' ), $tax_label );
	...
	public static function generate_target_rule_selector( $type, $selection_options, $input_name, $saved_values, $add_rule_label ) {
		...
		if ( 'display' == $type ) {
			...
			$output .= '<a href="#" class="button">' . __( 'Add Exclusion Rule', 'rts-header-footer-elementor' ) . '</a>';
			$output .= '</div>';
		}
		...
		if ( ! empty( $already_set_rule ) ) {
			add_action(
				...
				function() use ( $already_set_rule ) {
					...
					$notice = sprintf( __( 'The same display setting is already exist in %s post/s.', 'rts-header-footer-elementor' ), $rule_set_titles );
	...
	public static function get_post_selection( $post_type ) {
		...
		if ( ! empty( $all_headers ) ) {
			$headers = array(
				'' => __( 'Select', 'rts-header-footer-elementor' ),
			);
